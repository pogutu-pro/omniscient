...
export function AcademicsIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
...
export function PapersIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
...
export function ActivityIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M3 12h4l2.5 7L14 5l2 7h5" />
    </svg>
  );
}
...
export function SpinnerIcon(props: IconProps) {
  return (
    <svg {...base} className="spinner" {...props}>
